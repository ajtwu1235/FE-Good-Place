    ...
    return <>
        <div className="storyBox">
            <div className="storybox_wrap">
                <img src="/images/friedpork.png" alt="pork" className="story_food_img" />
                <div className="storybox_text">
                    <div className="storybox_wrap1">
                        ...
                        <img src="/images/heart-1.svg" alt="heart" className="story_like" />
                    </div> 
                    <p className="story_text story_title">수정이가 선택한 제주맛집 10곳</p>
                    ...
                    <div className="storybox_wrap2">
                        ...
                        <img src="/images/heart-1.svg" alt="heart" className="story_like_small" />
